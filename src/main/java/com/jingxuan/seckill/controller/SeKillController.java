...
import com.jingxuan.seckill.config.AccessLimit;
...
import com.jingxuan.seckill.rabbitmq.MQSender;
...
public class SeKillController implements InitializingBean {
    ...
    private volatile Map<Long, Boolean> EmptyStockMap = new HashMap<>();
...
//            model.addAttribute("errmsg", RespBeanEnum.EMPTY_STOCK.getMessage());
        ...
        //判断是否重复抢购
//        SeckillOrder seckillOrder = itSeckillOrderService.getOne(new QueryWrapper<SeckillOrder>().eq("user_id", user.getId()).eq("goods_id", goodsId));
        SeckillOrder seckillOrder = (TSeckillOrder) redisTemplate.opsForValue().get("order:" + user.getId() + ":" + goodsVo.getId());
        if (seckillOrder != null) {
